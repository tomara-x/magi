...
//TODO: (randomness / different way to overlap grains), gated envelopes, grain fm, midi? (ew)

rain =  gate*grntrg : ba.cycle(32) : par(i,32,en.are(0,r)*os.osc(frq)) :> fi.svf.notch(cf,q)*gain
with {
    ...
    frq = vslider("[-1]grain frq [scale:log] [style:knob]",440,0.0001,2e4,0.0001);
