...
with {
    t(x) = ba.sec2samp(l + lr * (noise(x+N) : ba.downSample(nr) : fi.svf.lp(nf,1)) : ba.sAndH(trigs : ba.selector(x,N)))
    with {
        l = vslider("v:[1]gate/[0]length [style:knob]",0.001,0.001,1,0.001);
